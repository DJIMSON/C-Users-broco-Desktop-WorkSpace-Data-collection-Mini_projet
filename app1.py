...
# Définition des chemins relatifs des fichiers (assurez-vous qu'ils sont dans votre dépôt)
PATHS = {
    "vetements": "coinafrique.csv",
    "chaussures": "coinafrique_ch.csv",
    "notebooks": [
        "data1.csv",
        "data2.csv"
    ],
    "background": "a-photo-of-clothing-and-shoes-in-a-shopp_1-W09orWT8iO1w3ZqbFwTA_ikM2TsvbSNyBF3K3aGLSNw.jpeg"
}
...
# Bouton pour afficher les données brutes complètes
...
# Bouton pour afficher les données scrappées par page
...
# Section des formulaires d'évaluation
